...
public final class ArmorAPIManager {
	...
	public static double resolveArmorPointStep() {
		double pointStep = featureAdapter.resolveArmorPointStep();
		return Double.isFinite(pointStep) && pointStep > 0.0D ? pointStep : 0.15D;
	}
